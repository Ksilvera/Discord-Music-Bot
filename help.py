...
class help(commands.Cog):
    ...
    {self.bot.command_prefix}p <url> - finds the song on youtube and plays it in your current channel. Also will resume playing the current song if it was paused
    ...
    @commands.command(name="send_to_all", help="send a message to all memebers")
